...
Run: python3 -m pytest -q scripts/wiki/test_scenarios_races.py

Every test drives scripts/wiki/wiki-deploy.sh end to end (subprocess) the way CI does, against:
