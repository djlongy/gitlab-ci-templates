...
#
#   usage: GITLAB_HOST=gitlab.example.com GITLAB_TOKEN=<api-scope PAT> \
#          scripts/wiki/wiki-bootstrap.sh group/project
#
...
#
# WIKI_SYNC_PROJECT  path of the templates project (default: platform/ci-templates)
...
host=${GITLAB_HOST:?set GITLAB_HOST, e.g. gitlab.example.com}
: "${GITLAB_TOKEN:?set GITLAB_TOKEN to an api-scope token}"
templates=${WIKI_SYNC_PROJECT:-platform/ci-templates}
